...
CREATE TABLE `newsList` (
    ...
    `long_des` VARCHAR(3000) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `newsList` ADD CONSTRAINT `newsList_catID_fkey` FOREIGN KEY (`catID`) REFERENCES `categories`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
